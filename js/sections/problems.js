        ...
        <div class="track-selector__board" style="background:transparent;">
            ...
            <div class="track-choose-btns">
                ...
                <a href="industrial.html" class="track-choose-btn track-choose-btn--ind" style="box-shadow: 6px 6px 0 #ffffff;">
                    <span class="track-choose-btn__icon">🚚</span>
                    <span class="track-choose-btn__label" style="text-shadow: 2px 2px 0 #333 !important;">INDUSTRY PROBLEM STATEMENTS</span>
                    <span class="track-choose-btn__sub">TOP COMPANIES · MULTIPLE DOMAINS</span>
                </a>
            </div>

            <p class="track-deadline">DEADLINE : APRIL 6th</p>
        </div>
    `;
}
