...
const FAQ_DATA = [
    ...
    { q: 'When and where will the hackathon be conducted?', a: '📍 Venue: Multi-Purpose Hall (MPH), SVCE, Sriperumbudur<br>📅 Date & Time:<br>• 27th April 2026 – 9:00 AM (Start)<br>• 28th April 2026 – ~2:00 PM (End)' },
