        ...
        problems: [
            {
                ...
                desc: 'Driver fatigue is a major cause of road accidents, often going undetected until it is too late. Existing solutions rely on camera-based systems or simple alert mechanisms, which are either intrusive or unreliable. There is a need for a wearable-based system that can continuously monitor physiological and behavioral signals to detect driver fatigue in real time. \n\nThe system should use wearable sensors to monitor: \n- Heart rate variability \n- Motion patterns (head/hand movement) \n- Activity levels \n\nBy analyzing these signals, the system should detect fatigue trends rather than sudden events. It must differentiate between normal inactivity and actual drowsiness. The system should provide graded alerts based on fatigue severity.',
                solution: [
    ...
    },
    {
        ...
        problems: [
            ...
            },
            {
                ...
                solution: [
                    'Upload Excel files (.xlsx / .csv) with: Rack ID, Shelf, Product, Quantity, Zone',
                    ...
                    'Detect issues: abnormal stock, empty/underused racks, data inconsistencies',
                    'Rack-level view: capacity vs usage, shelf-wise products, last updated info',
                ],
    ...
    },
    {
        ...
        problems: [
            ...
            },
            {
                ...
                desc: 'In the current digital ecosystem, users intending to purchase products—especially technical equipment such as smart devices, and electronics or any product —face a highly fragmented and overwhelming decision-making process. Multiple e-commerce platforms like Amazon and Flipkart offer thousands of product options with varying specifications, pricing, and user reviews. However, these platforms lack a unified, intelligent system that can interpret individual user requirements and provide optimized recommendations.\n Most users do not possess the technical expertise required to understand complex specifications such as resolution types, storage formats, connectivity protocols, or environmental suitability (indoor/outdoor usage). Additionally, product reviews are often inconsistent, biased, or manipulated, making it difficult to assess product reliability. Price variations across different platforms further complicate decision-making, as users are required to manually compare multiple sources to identify the most cost-effective option.\n Existing recommendation systems are largely generic and rely on basic filtering or popularity metrics rather than contextual user needs. They do not engage interactively with users to refine requirements or adapt recommendations dynamically. As a result, users often end up purchasing products that are either overpriced, unsuitable for their use case, or of lower quality.\n\n There is a critical need for a centralized, intelligent platform that can:\n\n Understand user-specific requirements through guided interaction Analyze large volumes of product data across platforms Evaluate authenticity and sentiment of user reviews Compare real-time pricing across vendors Provide personalized, reliable, and cost-effective product recommendations \n\nSuch a system would significantly enhance user decision-making, reduce time and effort, and ensure optimal utilization of financial resources.',
                solution: [
                    'The system will:',
